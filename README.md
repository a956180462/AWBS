...
- [文档目录](./docs/README.md)：所有产品文档、参考文档、任务记录和归档材料的总入口。
- [标准手册](./docs/MANUAL.md)：基于 003 可信数据链的正式使用、接入和维护手册。
...
- [当前特性总览](./docs/reference/AWBS_CURRENT_FEATURES.md)：当前初版已经实现的能力清单。
- [核心设计文档](./docs/reference/AWBS_CORE_DESIGN.md)：设计思想、架构、可信事实层和长期边界。
...
- [docs/README.md](./docs/README.md)：文档目录总入口。
...
- [docs/reference/AWBS_CORE_DESIGN.md](./docs/reference/AWBS_CORE_DESIGN.md)：核心思想、当前能力、技术架构、索引设计和 npm 包状态。
- [docs/reference/AWBS_CURRENT_FEATURES.md](./docs/reference/AWBS_CURRENT_FEATURES.md)：当前系统已实现特性的集中总览。
- [docs/tasks/TASK_001_VIEW_AUTHORITY.md](./docs/tasks/TASK_001_VIEW_AUTHORITY.md)：视图鉴权器、密封契约、明文镜像和鉴权目录总账。
- [docs/tasks/TASK_003_AUTHORITY_LEDGER_AND_DB_AUDIT.md](./docs/tasks/TASK_003_AUTHORITY_LEDGER_AND_DB_AUDIT.md)：AWBS 可信数据链、数据库审计和可信重建设计。
- [docs/tasks/TASK_004_TRUSTED_AUTHORITY_LAYER.md](./docs/tasks/TASK_004_TRUSTED_AUTHORITY_LAYER.md)：可信事实层、hash-linked ledger、Authority Service 和 trust anchor 设计。
- [docs/tasks/TASK_005_AUTHORITY_SESSION.md](./docs/tasks/TASK_005_AUTHORITY_SESSION.md)：A 模式运行期本地钥匙托管、controller token 和恢复流程。
- [docs/tasks/TASK_006_TRUST_BOUNDARY_HARDENING.md](./docs/tasks/TASK_006_TRUST_BOUNDARY_HARDENING.md)：可信边界加固、路径策略和 changeset payload 校验。
- [docs/tasks/TASK_007_TRUSTED_OPERATION_ENTRY.md](./docs/tasks/TASK_007_TRUSTED_OPERATION_ENTRY.md)：可信操作入口与 verify / repair 拆分。
