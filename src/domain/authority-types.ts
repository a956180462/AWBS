...
export type AuthorityEventType = "AUTHORITY_INITIALIZED" | "VIEW_CREATED" | "VIEW_REVOKED" | "CATALOG_RESEALED" | "MIRROR_REBUILT";
export type AuthorityPayloadType = "authority.catalog" | "authority.viewContract";
